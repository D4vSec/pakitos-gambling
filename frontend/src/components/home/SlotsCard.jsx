    ...
    <section className="relative max-w-6xl mx-auto px-4 md:px-8 lg:px-16 mt-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <Card className="group overflow-hidden bg-card/50 border border-border hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 rounded-xl">
          ...
          <div className="p-5">
            <h3 className="text-lg font-semibold">{t("general.home.slots.starwars.title")}</h3>
        ...
        <Card className="group overflow-hidden bg-card/50 border border-border hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 rounded-xl">
          ...
          <div className="p-5">
            <h3 className="text-lg font-semibold">{t("general.home.slots.stardewValley.title")}</h3>
            <p className="mt-1 text-sm text-muted-foreground">
        ...
        <Card className="group overflow-hidden bg-card/50 border border-border hover:bg-card/80 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 rounded-xl">
          ...
          <div className="p-5">
            <h3 className="text-lg font-semibold">{t("general.home.slots.beer.title")}</h3>
            <p className="mt-1 text-sm text-muted-foreground">
