  ...
  return (
    <section className="w-full">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-xl font-semibold text-base-content">Recent Earnings</h3>
      ...
      <div className="flex gap-3 overflow-hidden">
        {[
          ...
          <div
            key={i}
            className="min-w-45 h-28 rounded-xl bg-base-200 border border-base-300 p-3 flex flex-col justify-between"
          >
            <div>
              <p className="text-base font-semibold text-base-content">{item.user}</p>
