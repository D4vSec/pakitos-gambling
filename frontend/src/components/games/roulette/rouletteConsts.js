...
const CHIPS = [
    { idSuffix: "5", value: 5, color: "#1e88e5", edgeColor: "#0d47a1", shadowColor: "#000" }, // Azul
    { idSuffix: "10", value: 10, color: "#2e7d32", edgeColor: "#1b5e20", shadowColor: "#000" }, // Verde
    { idSuffix: "25", value: 25, color: "#f4511e", edgeColor: "#bf360c", shadowColor: "#000" }, // Naranja
    { idSuffix: "50", value: 50, color: "#8e24aa", edgeColor: "#4a148c", shadowColor: "#000" }, // Púrpura
    { idSuffix: "100", value: 100, color: "#0d47a1", edgeColor: "#002171", shadowColor: "#000" }, // Azul muy oscuro
    { idSuffix: "200", value: 200, color: "#00695c", edgeColor: "#003d33", shadowColor: "#000" }, // Turquesa oscuro
    { idSuffix: "500", value: 500, color: "#c2185b", edgeColor: "#880e4f", shadowColor: "#000" }, // Rosa oscuro
    {
        idSuffix: "1000",
        value: 1000,
        displayValue: "1K",
...
export { ROULETTE_VALUES, CHIPS, CHIP_VALUES }
