...
const GameScreen = ({ game, controls }) => {
  return (
    <div className="grid h-[calc(100dvh-4rem-0.75rem)] w-full min-w-0 gap-3 overflow-hidden md:h-[calc(100dvh-4rem-1rem)] md:gap-4 lg:h-[calc(100dvh-12.5rem)] lg:grid-cols-[minmax(0,3fr)_minmax(18rem,1fr)] lg:grid-rows-1 lg:gap-6 grid-rows-[minmax(0,1fr)_auto]">
