...
[ ] Implementar función de truncado (ej. 8132...dacc).
[ ] Añadir botón "Copy to clipboard" discreto al lado del ID.
[ ] Mostrar el UUID completo al hacer hover.
[ ] Integrar la función buildUserAgent en el mapeo de la tabla.
...
[ ] Crear componente Badge para roles.
[ ] Configurar colores: Admin (Azul suave / Indigo), User (Gris / Slate).
[ ] Redimensionar el botón "Clear search".
[ ] Integrarlo como un icono de "X" dentro del propio input field.
