...
[x] Sustituir el texto plano en la columna "Details" por un componente de visualización de JSON colapsable (ej. react-json-view o similar).
...
[x] Mover el botón "Create new user" a la parte superior derecha de la sección (encima de la tabla).
[x] Reubicar "View logs" como una pestaña de navegación o un botón de acción contextual, eliminando botones flotantes innecesarios.
